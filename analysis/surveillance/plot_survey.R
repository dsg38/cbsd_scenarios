...
df = survey_sf_split[[1]]

africa_polys_df = utils_epidem$getAfricaPolys()

# world = rnaturalearth::ne_countries(scale = "medium", returnclass = "sf")

# countryPoly = world[world$iso_a3==thisCountryCode,]
...
numFields = nrow(df)
# vectorSum =  round(sum(df$whitefly_mean, na.rm=TRUE), 2)

# TODO: Add num pos / total to plot title
...
p = ggplot() +
    ...
    # ggtitle(paste0(name, ": ", thisCountryCode, " ", thisYear, "\nnumFields: ", numFields)) + 
