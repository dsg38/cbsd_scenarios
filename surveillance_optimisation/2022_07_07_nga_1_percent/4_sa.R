...
sol = simulated_annealing(objectiveFun, extent=rasterExtent, startCoordsDf = startCoordsDf, rewardRatio=rewardRatio, niter=4000)
...
dir.create("./plots/trace/", showWarnings = FALSE, recursive = TRUE)
